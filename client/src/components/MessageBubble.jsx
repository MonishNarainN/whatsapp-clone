  ...
  return (
    <div className={`flex flex-col mb-1 max-w-[75%] message-bubble-container animate-spring-pop transform transition-transform hover:scale-[1.01] duration-200 ${isMine ? 'items-end' : 'items-start'}`}>
      ...
      >
        ...
        {/* Timestamp on hover */}
        <div className={`timestamp-hover text-[11px] ${isMine ? 'text-white/80 text-right' : 'text-gray-500 dark:text-gray-400 text-right'} flex items-center justify-end gap-1 font-medium tracking-wide`}>
