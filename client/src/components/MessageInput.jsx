...
export default function MessageInput({ onSend, socket, conversationId, currentUser }) {
  ...
  return (
    <div className="bg-[#111827]/80 backdrop-blur-xl px-4 py-3 flex items-center border-t border-gray-700/50 relative">
      ...
      <div className="flex items-center gap-3 text-gray-400 mr-2 shrink-0">
        <button className="hover:text-green-400 transition-colors p-2 rounded-full hover:bg-gray-800 active:scale-95">
      ...
      <form 
        onSubmit={handleSend} 
        className="flex-1 flex items-center bg-[#1f2937]/90 rounded-2xl pr-1.5 pl-4 shadow-inner border border-gray-700 focus-within:border-green-500 focus-within:ring-1 focus-within:ring-green-500/50 transition-all duration-300 group peer"
      >
        <input
          ref={inputRef}
          type="text"
          placeholder="Type a message"
          className="flex-1 py-3.5 focus:outline-none bg-transparent text-gray-100 placeholder-gray-500 text-[15px]"
          value={text}
